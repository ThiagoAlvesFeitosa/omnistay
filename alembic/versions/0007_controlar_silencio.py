"""Tipo enviar_lembrete, estado_cadastro e prazos de silencio.

Revision ID: 0007_controlar_silencio
Revises: 0006_interpretar_ficha
"""
...
revision = "0007_controlar_silencio"
down_revision = "0006_interpretar_ficha"
branch_labels = None
depends_on = None

ARQUIVO_SQL = Path(__file__).parent / "sql" / "0007_controlar_silencio.sql"
...
def downgrade() -> None:
    cursor = op.get_bind().connection.cursor()
    cursor.execute("DROP INDEX IF EXISTS uq_trabalho_enviar_lembrete_reserva;")
