"""Sinal precisa_atendimento_humano na vw_fila_do_dia.

Revision ID: 0010_classificar_intencao
Revises: 0009_receber_mensagem
"""
...
revision = "0010_classificar_intencao"
down_revision = "0009_receber_mensagem"
branch_labels = None
depends_on = None

ARQUIVO_SQL = Path(__file__).parent / "sql" / "0010_classificar_intencao.sql"
