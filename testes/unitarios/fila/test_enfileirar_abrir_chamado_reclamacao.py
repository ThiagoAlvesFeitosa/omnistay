"""Enfileira abrir_chamado_reclamacao sem consumir."""
...
def test_enfileirar_abrir_chamado_grava_tipo_e_ids(ambiente):
    ...
    with ambiente.engine.begin() as conexao:
        ...
        id_trabalho = fila_service.enfileirar_abrir_chamado_reclamacao(
            conexao,
            id_hotel=id_hotel,
        ...
        assert linha["tipo"] == "abrir_chamado_reclamacao"
