"""Claim da fila consome enviar_confirmacao_resolucao."""
...
def test_reclamar_proximo_consome_enviar_confirmacao_resolucao(ambiente):
    ...
    with ambiente.engine.begin() as conexao:
        ...
        conexao.execute(
            text(
                ...
                "VALUES (:h, 'enviar_confirmacao_resolucao',"
                " CAST(:p AS jsonb), 'pendente')"
            ),
            {
                "h": id_hotel,
                "p": '{"id_reserva": %s, "id_solicitacao": 9, "id_mensagem": 8}'
                % id_reserva,
            },
        )
        ...
        assert reclamado["tipo"] == "enviar_confirmacao_resolucao"
