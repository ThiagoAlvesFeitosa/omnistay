"""Enfileira responder_duvida sem consumir."""
...
def test_enfileirar_responder_duvida_grava_tipo_e_ids(ambiente):
    ...
    with ambiente.engine.begin() as conexao:
        id_reserva = conexao.execute(
            text(
                ...
                "VALUES (:h, '5511999990000', CURRENT_DATE, CURRENT_DATE + 2) "
                "RETURNING id_reserva"
            ),
            {"h": id_hotel},
        ).scalar_one()
        id_trabalho = fila_service.enfileirar_responder_duvida(
            conexao,
            id_hotel=id_hotel,
        ...
        assert linha["tipo"] == "responder_duvida"
